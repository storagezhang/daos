...
class DserializeCommand(ExecutableCommand):
    ...
    def __init__(self, namespace, command):
        ...
        super(DserializeCommand, self).__init__(namespace, command)
    ...
    def get_param_names(self):
        ...
        param_names = super(DserializeCommand, self).get_param_names()
...
class Dserialize(DserializeCommand):
    ...
    def __init__(self, hosts, timeout=30):
        ...
        super(Dserialize, self).__init__(
...
class DdeserializeCommand(ExecutableCommand):
    ...
    def __init__(self, namespace, command):
        ...
        super(DdeserializeCommand, self).__init__(namespace, command)
    ...
    def get_param_names(self):
        ...
        param_names = super(DdeserializeCommand, self).get_param_names()
...
class Ddeserialize(DdeserializeCommand):
    ...
    def __init__(self, hosts, timeout=30):
        ...
        super(Ddeserialize, self).__init__(
