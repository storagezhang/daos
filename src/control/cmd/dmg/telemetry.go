...
type metricsCmd struct {
	List  metricsListCmd  `command:"list" alias:"l" description:"List available metrics on a DAOS storage node"`
	Query metricsQueryCmd `command:"query" alias:"q" description:"Query metrics on a DAOS storage node"`
}
...
type metricsQueryCmd struct {
	...
	hostListCmd
	jsonOutputCmd
	Metrics string `short:"m" long:"metrics" default:"all" description:"Comma-separated list of metric names, or all"`
}
